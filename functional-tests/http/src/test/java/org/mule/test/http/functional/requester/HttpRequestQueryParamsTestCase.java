...
public class HttpRequestQueryParamsTestCase extends AbstractHttpRequestTestCase {
  ...
  public void queryParamAppendDefault() throws Exception {
    ...
    String filterQP = "filter=username%2Capps";
    String testQP = "testName1=testValue1";
    String path = "testPath";
    assertThat(uri, allOf(containsString(path), containsString(testQP), containsString(filterQP)));
  }
