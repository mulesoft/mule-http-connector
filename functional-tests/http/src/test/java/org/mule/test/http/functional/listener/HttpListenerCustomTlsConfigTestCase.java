...
public class HttpListenerCustomTlsConfigTestCase extends AbstractHttpTestCase {
  ...
  @Rule
  public SystemProperty trustStorePath =
      new SystemProperty("trustStorePath", getDefaultEnvironmentConfiguration().getTestSslCaCerts());

  @Rule
  public SystemProperty keyStorePath =
      new SystemProperty("keyStorePath", getDefaultEnvironmentConfiguration().getTestSslKeyStore());
