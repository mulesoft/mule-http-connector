...
public class HttpsRequesterSniTestCase extends AbstractHttpTestCase {
  ...
  public void testClientSNISentOnFQDN() throws Exception {
    ...
    assumeThat("SNI requires a fully qualified domain name. \"localhost.localdomain\" is used but it is not commonly present on MacOSX hosts. An assumption will prevent its execution unless the domain exists. Although is recommended to add the aforementioned domain to the /etc/hosts file if it's not present.",
