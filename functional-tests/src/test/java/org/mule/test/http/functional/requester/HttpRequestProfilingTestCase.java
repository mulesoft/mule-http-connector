...
public class HttpRequestProfilingTestCase extends AbstractHttpRequestTestCase {
  ...
  private static final class TestProfilingDataProducer
    ...
    @Override
    public void triggerProfilingEvent(Object baseInfo, Function<Object, ExtensionProfilingEventContext> transformation) {
      this.lastProfilingEventContext = transformation.apply(baseInfo);
    }
