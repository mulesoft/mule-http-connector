...
public class SecureEndpointInRequester implements Validation {

  private final ComponentIdentifier HTTP_REQUESTER_CONNECTION =
      ComponentIdentifier.builder().namespace("http").name("request-connection").build();
  ...
  public Predicate<List<ComponentAst>> applicable() {
    return currentElemement(equalsNamespace("http")
        .and(equalsIdentifier(HTTP_REQUESTER_CONNECTION)));
  }
