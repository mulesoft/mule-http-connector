...
public class HttpResponseBuilderWrapper implements HttpResponseBuilder {

  private final org.mule.runtime.http.api.domain.message.response.HttpResponseBuilder builder;

  public HttpResponseBuilderWrapper(org.mule.runtime.http.api.domain.message.response.HttpResponseBuilder builder) {
