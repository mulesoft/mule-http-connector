 ...
 * LICENSE.txt file.
 */
package org.mule.extension.http.internal.service.message.copy.message.muletosdk;
...
public class HttpEntityWrapper implements HttpEntity {
  ...
  public Collection<Part> getParts() throws IOException {
    return muleEntity.getParts().stream().map(HttpPartWrapper::new).collect(toList());
  }
  ...
  public OptionalLong getBytesLength() {
    return getLength().map(OptionalLong::of).orElseGet(OptionalLong::empty);
  }
}
