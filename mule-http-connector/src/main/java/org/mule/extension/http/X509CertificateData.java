...
public class X509CertificateData {
  ...
  public X509CertificateData(String subjectDN, String issuerDN, BigInteger serialNumber, Date notBefore, Date notAfter,
                             PublicKeyData publicKeyData, String sigAlgName, String sigAlgOID, byte[] sigAlgParams, byte[] signature,
                             int version, int basicConstraints, List<String> extendedKeyUsage, boolean[] keyUsage,
                             List<AlternativeNameData> subjectAlternativeNames, List<AlternativeNameData> issuerAlternativeNames, List<CertificateExtension> extensions) {
